...
JNIEXPORT jint JNICALL Java_com_xingfeng_sxliveplayer_ELPlayerController_retry(
    ...
    if(NULL != playerHandle){
        ...
        ((VideoPlayerController*)mELPlayerController)->init(videoMergeFilePath, g_jvm, g_obj, max_analyze_duration_params, size, probesize, fpsProbeSizeConfigured, minBufferedDuration, maxBufferedDuration);
